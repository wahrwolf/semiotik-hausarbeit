...
\newcommand{\trtype}{Hausarbeit} %{Diplomarbeit} %{Dissertation}
...
\newcommand{\trinstitute}{Biologie}
\newcommand{\trwebsiteordate}{{https://www.biologie.uni-hamburg.de/forschung/evolutionsbiologie/geschnatwiss.html}}
\newcommand{\trdate}{\today}

\newcommand{\trcourseofstudies}{Informatik} %{Bioinformatik} %{Intelligent Adaptive Systems} 
\newcommand{\trauthordegree}{} %{\ B.Sc.}
\newcommand{\trgutachterA}{\href{mailto:jschult47@gmail.com}{Prof. Dr. Joachim Schult}}
%\newcommand{\trgutachterB}{\href{mailto:heinrich@informatik.uni-hamburg.de}{Dr. Stefan Heinrich}}
...
% provide tightlist command for pandoc
